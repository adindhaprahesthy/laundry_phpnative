...
if($_POST){
    ...
    if(empty($status)) {
        ...
        include "koneksi.php";
            ...
            if($update){
                echo "<script>alert('Success update transaksi');location.href='tampil_transaksi.php';</script>";

            } else {
                echo "<script>alert('Fail update transaksi');location.href='ubah_transaksi.php?id_transaksi=".$id_transaksi."';</script>";
